...
const WidePushupPage = ({navigation}) => {
    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.ExnameBox}>
          <Text style={styles.Exname}>가슴운동 {'>'} 와이드 푸쉬업</Text>
        </View>
        <View style={styles.VideoBox}>
          <Image
            style={{width: '100%', height: '100%'}}
            source={{
              uri: 'https://menshealthkorea.com/wp-content/uploads/2020/10/MH202011-15min-2.gif',
            }}
          />
        </View>
        ...
        <View style={{...styles.Submenu3, display: waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
            1. 팔을 어깨너비보다 1.4배 ~ 1.6배 정도 넓게 벌린 후 바닥을 짚는다.
          </Text>
          <Text style={styles.SubmenuText2}>
