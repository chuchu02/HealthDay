    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.ExnameBox}>
          <Text style={styles.Exname}>등 운동 {'>'} W 레이즈</Text>
        </View>
        <View style={styles.VideoBox}>
          <Image
            style={{width: '100%', height: '100%'}}
            source={{
              uri: 'https://blog.kakaocdn.net/dn/sumew/btrx5Avo1Nk/eAb5G0FZ0m8k99H0HhIksK/img.gif',
            }}
          />
        </View>
        ...
        <View style={{...styles.Submenu3, display: waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
            1. 가슴과 허리를 펴고 복부에 긴장을 준 상태로 팔을 수직으로 펴고
            바닥에 엎드린다.
          </Text>
          <Text style={styles.SubmenuText2}>
            2. 호흡을 내쉬면서 팔을 W 모양으로 등과 평행을 이루도록 들어준다.
          </Text>
          <Text style={styles.SubmenuText2}>
