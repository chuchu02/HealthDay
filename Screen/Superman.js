    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.ExnameBox}>
          <Text style={styles.Exname}>등 운동 {'>'} 풀업 슈퍼맨</Text>
        </View>
        <View style={styles.VideoBox}>
          <Image
            style={{width: '100%', height: '100%'}}
            source={{
              uri: 'https://blog.kakaocdn.net/dn/bWHPkO/btrx4SbWPWC/BQyvSoze1Ts0mN7HNceY51/img.gif',
            }}
          />
        </View>
        ...
        <View style={{...styles.Submenu3, display: waying ? 'flex' : 'none'}}>
          ...
          <Text style={styles.SubmenuText2}>
            2.팔을 사선 방향으로 등과 평행을 이루도록 들어준다.
          </Text>
          <Text style={styles.SubmenuText2}>
            3. 호흡을 내쉬면서 팔을 몸통 방향으로 당기면서 등에 자극을 느낀다.
          </Text>
          <Text style={styles.SubmenuText2}>
            4. 호흡을 들이 마시면서 천천히 시작 위치로 돌아간다.
          </Text>
        </View>
        <View style={{...styles.Submenu3, display: !waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
