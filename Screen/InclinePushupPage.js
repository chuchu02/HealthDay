...
const InclinePushupPage = ({navigation}) => {
    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.ExnameBox}>
          <Text style={styles.Exname}>가슴운동 {'>'} 인클라인푸쉬업</Text>
        </View>
        <View style={styles.VideoBox}>
          <Image
            style={{width: '100%', height: '100%'}}
            source={{
              uri: 'https://k.kakaocdn.net/dn/sLX6D/btqPnaOa7ev/RHH5HoomopgQ2IMiGdJId0/img.gif',
            }}
          />
        </View>
        ...
        <View style={{...styles.Submenu3, display: waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
            1. 팔을 어깨너비보다 조금 넓게 벌려 벤치를 짚는다.
          </Text>
          <Text style={styles.SubmenuText2}>
            2. 호흡을 들이마시면서 천천히 팔꿈치를 굽힌다.
          </Text>
          <Text style={styles.SubmenuText2}>
            3. 가슴과 벤치 사이가 주먹 하나 정도에서 잠시 정지한 후 운동 부위
            자극에 집중한다.
          </Text>
          <Text style={styles.SubmenuText2}>
        ...
        <View style={{...styles.Submenu3, display: !waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
            1. 손으로 짚는 사물의 높이는 일반적인 벤치 높이로 한다.
          </Text>
          <Text style={styles.SubmenuText2}>
...
export default InclinePushupPage;
