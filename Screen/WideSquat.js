    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.ExnameBox}>
          <Text style={styles.Exname}>하체 운동 {'>'} 와이드 스쿼트</Text>
        </View>
        <View style={styles.VideoBox}>
          <Image
            style={{width: '100%', height: '100%'}}
            source={{
              uri: 'https://mblogthumb-phinf.pstatic.net/20160907_237/goldtiger623_1473250396433aCbm3_GIF/%C7%E3%BE%C80.gif?type=w2',
            }}
          />
        </View>
        ...
        <View style={{...styles.Submenu3, display: waying ? 'flex' : 'none'}}>
          <Text style={styles.SubmenuText2}>
            1. 다리를 어꺠 넓이 보다 넓게 벌리고 발끝은 바깥쪽 45도를 향하게
            선다.
          </Text>
          <Text style={styles.SubmenuText2}>
